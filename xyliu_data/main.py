...
parser.add_argument('--train_set', type=str, default='restauranttrain.bio.txt')
parser.add_argument('--test_set', type=str, default='restauranttest.bio.txt')
parser.add_argument('--batch_size', type=int, default=50)
parser.add_argument('--log_every_n_batch', type=int, default=10)
parser.add_argument('--max_step', type=int, default=2000, help='training for this many batches')
